import 'package:calculator/pages/add_page.dart';
import 'package:calculator/pages/division_page.dart';
import 'package:calculator/pages/mulitplication_page.dart';
import 'package:calculator/pages/sub_page.dart';
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>SubstractionPage() ));
                  },
                  child: Text(
                    "Substraction",
                    style: TextStyle(
